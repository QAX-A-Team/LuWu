<template>
    <div>
        <v-snackbar :color="currentNotificationColor" :timeout="currentNotificationContentTimeout" v-model="show">
...
export default class NotificationsManager extends Vue {
        ...
        if (newNotification !== this.currentNotification) {
            ...
            if (newNotification) {
                dispatchRemoveNotification(this.$store, {
                    ...
                    timeout: this.currentNotificationContentTimeout,
                });
            }
        }
    }
    ...
    public get currentNotificationContentTimeout() {
        return (this.currentNotification && this.currentNotification.timeout) || 6500;
    }
}
</script>
