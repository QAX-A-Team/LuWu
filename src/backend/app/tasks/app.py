...
from app.tasks import config as config_task
from app.tasks import domain as domain_task
from app.tasks import module as module_task
from app.tasks import vps as vps_task
